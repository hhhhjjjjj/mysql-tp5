...
class Check extends Base
{
    public function check(){
        ...
        $list=db()->table('keti_list')
            ...
            ->field('a.id,a.keti_name,a.origin,a.teacher,a.jiaoyan,a.detail,a.checkS_state,a.gonghao,a.xuehao,b.check_state')
            ->paginate(5,false,[]);
    ...
    public function shenhe(){
        if(request()->isPost()){
            ...
            $data_se['checkS_state']=$data['state'];
            $bool1=db()->table('check_list')->where('xuehao',$user_xuehao)->update($data);
            ...
            $id=input('id');
            $data=db()->table('check_list')->where('xuehao',$xuehao)->find();
            $info['wancheng']=$data['wancheng'];
            $info['weicheng']=$data['weicheng'];
